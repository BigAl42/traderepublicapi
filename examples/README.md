...
The library also supports cash, portfolio (`compact_portfolio_by_type` is the current TR web endpoint), search, quotes, savings plans, and timeline v2 details. See [docs/API.md](../docs/API.md).
